...
$(function() {
  ...
  function set_settings() {
    ...
    settings.defaultredirect = 'https://adelphiderner.co1.qualtrics.com/jfe/form/SV_afSww3RR30TjmXr';
  ...
  function init_task() {
    ...
    $('#final-continue').on('click', function() {
      ...
      // Redirect link
    location.href = 'https://adelphiderner.co1.qualtrics.com/jfe/form/SV_afSww3RR30TjmXr';
